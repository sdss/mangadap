...
kinematics module
(:class:`mangadap.proc.stellarcontinuummodel.StellarContinuumModel`) and
the emission-line module
(:class:`mangadap.proc.emissionlinemodel.EmissionLineModel`), use
template libraries to fit the stellar continuum.  We describe below the
template libraries included in the DAP repository and the format needed
...
+=================+============+=========+=============+==========================================================================================================+
| BC03            |  [1]_ [2]_ |     SPS |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/bc03_mpajhu/README>`__     |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| BPASS           |       [3]_ |     SPS | Theoretical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/bpass/README>`__           |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| M11ELODIE       |       [4]_ |     SPS |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/m11_elodie/README>`__      |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| M11MARCS        |       [4]_ |     SPS | Theoretical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/m11_marcs/README>`__       |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| M11MILES        |       [4]_ |     SPS |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/m11_miles/README>`__       |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| M11STELIB       |       [4]_ |     SPS |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/m11_stelib/README>`__      |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| M11STELIBZSOL   |       [4]_ |     SPS |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/m11_stelib_zsol/README>`__ |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| MASTARHC        |       [5]_ | Stellar |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/mastarhc/README>`__        |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| MILES           |       [6]_ | Stellar |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/miles/README>`__           |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| MILESAVG        |       [6]_ | Stellar |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/miles_avg/README>`__       |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| MILESHC         |       [7]_ | Stellar |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/miles_cluster/README>`__   |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| MILESTHIN       |       [6]_ | Stellar |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/miles_thin/README>`__      |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| MIUSCAT         |       [8]_ |     SPS |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/miuscat/README>`__         |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| MIUSCATTHIN     |       [8]_ |     SPS |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/miuscat_thin/README>`__    |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
| STELIB          |       [9]_ | Stellar |   Empirical | `README <https://github.com/sdss/mangadap/blob/master/data/spectral_templates/stelib/README>`__          |
+-----------------+------------+---------+-------------+----------------------------------------------------------------------------------------------------------+
...
:func:`mangadap.config.defaults.default_dap_common_path`, and the output
file name is set by
