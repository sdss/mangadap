...
;
; CALLING SEQUENCE:
;       MANGA_DAP, inptbl=inptbl, index=index, drppath=drppath, dappath=dappath, /nolog, /quiet, $
;                  /plot, /dbg
;
;           or
;
;       MANGA_DAP, par=par, drppath=drppath, dappath=dappath, /nolog, /quiet, /plot, /dbg
;
; INPUTS:
;
; OPTIONAL INPUTS:
...
PRO MANGA_DAP, $
        inptbl=inptbl, index=index, par=par, drppath=drppath, dappath=dappath, nolog=nolog, $
        quiet=quiet, plot=plot, dbg=dbg
