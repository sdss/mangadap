...
;                                             Ha6563=Ha6563, SII6717=SII6717, plotsp=plotsp
;
; INPUTS:
;       shift0 double
...
; OUTPUT:
;       result structure
;               Structure containing the fitting results.  Each line (9
;               in total) has a 6-element dblarr in the structure.  The
;               elements are the three parameters of the fitted Gaussian
;               using the IDL task GAUSS1(): (line centroid, sigma, and
;               area=flux) and the formal (MPFIT) errors in those
;               parameters.
;
;       emfit dblarr[C]
...
;
; REVISION HISTORY:
;       10 Dec 2014: (KBW) Incorporation of code written by Enci into
;                          the DAP.  Allow for a mask.
;-
;------------------------------------------------------------------------------

PRO MDAP_FIT_EMISSION_LINE_SPECTRUM_ENCI, $
                shift0, lambda, pure_emi, err, mask, result, emfit, OII3727=OII3727, $
                Hb4861=Hb4861, OIII5007=OIII5007, Ha6563=Ha6563, SII6717=SII6717, plotsp=plotsp
...
result={ OII3727:fltarr(6),Hb4861:fltarr(6),OIII4959:fltarr(6),OIII5007:fltarr(6),$
         NII6548:fltarr(6),Ha6563:fltarr(6),NII6583:fltarr(6),$
		 SII6717:fltarr(6),SII6731:fltarr(6)}
