...
;===============================================================================
;   1: RADIAL: 10 logarithmically spaced radial bins; S/N>0
...
;           emission-line
;           abs-indices
;   2: RADIAL: 10 logarithmically spaced radial bins; S/N>0
;       Use velocity registration (based on velocities from CUBE iter 2)
;       MIUSCAT-THIN (72 templates: Salpeter IMF; every other age <14 Gyr; three metallicities)
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   3: ALL: Bin all fibers; S/N>0
;       Use velocity registration (based on velocities from CUBE iter 2)
;       MILES-THIN (219 stars drawn from a 12x12x12 grid in logT, logg, and [Fe/H])
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   4: ALL: Bin all fibers; S/N>0
;       Use velocity registration (based on velocities from CUBE iter 2)
;       *Full MILES*
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   5: ALL: Bin all fibers; S/N>0
;       Use velocity registration (based on velocities from CUBE iter 2)
;       MIUSCAT-THIN (72 templates: Salpeter IMF; every other age <14 Gyr; three metallicities)
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   6: ALL: Bin all fibers; S/N>0
;       **No velocity registration**
;       MIUSCAT-THIN (72 templates: Salpeter IMF; every other age <14 Gyr; three metallicities)
;           stellar-cont (2 moments)
;           emission-line
...
PRO CREATE_MANGA_DAP_EXECUTION_PLAN, $
        ...
        niter = 6                                       ; Number of ExecutionPlans to produce
        ...
        tpl_lib_analysis[5] = 'MIUSCAT-THIN'
        analysis_prior[5] = ''
