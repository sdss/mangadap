...
;-----------------------------------------------------------------------
        ...
        tpl_lib_analysis = strarr(niter)                ; Template library keyword
        ems_par_analysis = strarr(niter)                ; Emission-line parameter keyword
        abs_par_analysis = strarr(niter)                ; Spectral-index parameter keyword
