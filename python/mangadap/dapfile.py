...
*Imports*::
    ...
    from mangadap.config.defaults import default_analysis_path, default_dap_common_path
...
class dapfile:
    ...
    def __init__(self, plate, ifudesign, mode, bintype, niter, drpver=None, dapver=None,
        ...
        if directory_path is None:
            ...
            self.directory_path = default_dap_common_path(plate=self.plate, drpver=self.drpver,
                                                             dapver=self.dapver,
