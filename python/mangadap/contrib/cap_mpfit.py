...
Perform Levenberg-Marquardt least-squares minimization, based on MINPACK-1.
 ...
 - Converted from Numeric to numpy (Sergey Koposov, July 2008)
    ...
    V1.2.0: Fixed *major* instabilities for degenerate Jacobians, especially 
      ...
      - Made sure x and x+h differ by an exactly representable number in fdjac2.
...
###############################################################################
    ...
    def parinfo(self, parinfo=None, key='a', default=None, n=0):
        ...
        if key in parinfo[0]:
            ...
            values = np.full(len(parinfo), default)
...
###############################################################################
    ...
    def fdjac2(self, fcn, x, fvec, step=None, ulimited=None, ulimit=None,
        ...
        # Make sure x and x+h differ by an exactly representable number
        for j in range(n):
            xp = xall.copy()
            temp = xp[ifree[j]] + h[j]
            h[j] = temp - xp[ifree[j]]
