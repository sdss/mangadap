...
;For CUBE files:
;   1: Bin to S/N=30; only include S/N>5 spectra (r-band continuum)
;       MILES-THIN (219 stars drawn from a 12x12x12 grid in logT, logg, and [Fe/H])
;           stellar-cont (4 moments)
;           emission-line
;           abs-indices
;   2: Fit all spaxels with a continuum S/N>0, no binning
;       MIUSCAT-THIN (72 templates: Salpeter IMF; every other age <14 Gyr; three metallicities)
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   3: 10 logarithmically spaced radial bins; S/N>0
;       **No velocity registration**
;       MIUSCAT-THIN (72 templates: Salpeter IMF; every other age <14 Gyr; three metallicities)
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   4: 10 logarithmically spaced radial bins; S/N>0
;       Use velocity registration (based on velocities from iter 2)
;       MIUSCAT-THIN (72 templates: Salpeter IMF; every other age <14 Gyr; three metallicities)
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   5: Bin all "valid" spaxels; S/N>0
;       Use velocity registration (based on velocities from iter 2)
;       MILES-THIN (219 stars drawn from a 12x12x12 grid in logT, logg, and [Fe/H])i
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   6: Bin all "valid" spaxels; S/N>0
;       Use velocity registration (based on velocities from iter 2)
;       *Full MILES*
;           stellar-cont (2 moments)
;           emission-line
;           abs-indices
;   7: Bin all "valid" spaxels; S/N>0
;       Use velocity registration (based on velocities from iter 2)
;       MIUSCAT-THIN (72 templates: Salpeter IMF; every other age <14 Gyr; three metallicities)
;           stellar-cont (2 moments)
;           emission-line
