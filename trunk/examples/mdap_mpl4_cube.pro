...
;
; Dummy plans are inserted to make the indexing easier:
;   M11-STELIB-ZSOL results are *-00?.fits
;   MIUSCAT-THIN    results are *-01?.fits
;   MILES-THIN      results are *-02?.fits
;
...
PRO CREATE_MANGA_DAP_EXECUTION_PLAN, $
        ...
        execute_flag[0:8] = 0           ; M11-STELIB-ZSOL
        execute_flag[10:18] = 0         ; MIUSCAT-THIN
        execute_flag[20:28] = 1         ; MILES-THIN
...
;       execute_flag[i] = 0
        bin_par[i+10].type = 'STON'
        bin_par[i+10].ston = 30.0d
        threshold_ston_bin[i+10] = 5.0d
        analysis_par[i+10].moments = 4
;       execute_flag[i+10] = 0
        bin_par[i+20].type = 'STON'
        bin_par[i+20].ston = 30.0d
        threshold_ston_bin[i+20] = 5.0d
        analysis_par[i+20].moments = 4
;       execute_flag[i+20] = 0
        i++
...
;       execute_flag[i] = 0
        bin_par[i+10].type = 'STON'
        bin_par[i+10].ston = 5.0d
;       execute_flag[i+10] = 0
        bin_par[i+20].type = 'STON'
        bin_par[i+20].ston = 5.0d
;       execute_flag[i+20] = 0
        i++
        ...
        bin_par[i].type = 'NONE'
;       execute_flag[i] = 0
        bin_par[i+10].type = 'NONE'
;       execute_flag[i+10] = 0
        bin_par[i+20].type = 'NONE'
;       execute_flag[i+20] = 0
        i++
