...
%
x2d            & Array containing the x coordinates in arcseconds (0 is the center of the galaxy, determined via a centroid fitting). 
...
%
y2d            & Array containing the y coordinates in arcseconds (0 is the center of the galaxy, determined via a centroid fitting). 
               [NxM elements array] in the case that the inputs are in datacube format, or 
               [N elements array] in the case the inputs are in RSS format. \\
%
